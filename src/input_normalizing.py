...
dynab     = pd.read_csv(PROJECT_ROOT / 'data/sampled/dynab_sampled_500.csv')
hatecheck = pd.read_csv(PROJECT_ROOT / 'data/sampled/hatecheck_sampled_500.csv')
ishate    = pd.read_csv(PROJECT_ROOT / 'data/sampled/ishate_sampled_500.csv')
linghate  = pd.read_csv(PROJECT_ROOT / 'data/sampled/linghate_sampled_500.csv')
toxigen   = pd.read_csv(PROJECT_ROOT / 'data/sampled/toxigen_sampled_500.csv')
...
target_normalized = pd.read_csv(PROJECT_ROOT / 'data/demographic_normalizing.csv')
...
master_df.to_csv(PROJECT_ROOT / "data/input_biased_text_before_author_annot.csv", index=False)
print(f"\nMaster DataFrame saved - input_biased_text_before_author_annot.csv  {master_df.shape}")
...
master_df_annotated = pd.read_csv(annot_path)
...
master_df_annotated.to_csv(PROJECT_ROOT / "data/input_biased_text.csv", index=False)
print(f"Annotated DataFrame saved  -  input_biased_text.csv  {master_df_annotated.shape}")
